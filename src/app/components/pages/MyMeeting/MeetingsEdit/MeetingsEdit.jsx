...
import { processEditMeeting, processVerifyMeeting, deleteMeeting } from "../../../../store/mutations";
            ...
            <div className="card card-info">
              ...
              <form className="form-horizontal" onSubmit={processEditMeeting}>
                ...
                <div className="card-footer text-right">
                  ...
                  <button type="button" className="btn bg-gradient-danger mr-2" onClick={() => deleteMeeting(mymeeting.id)}><i className="fas fa-trash"></i> Delete</button>
