...
export const Meeting = ({meetings, dtoday, isAdmin}) => (
      ...
      {meetings.map((meeting) => (
        <tr key={meeting.id}>
          ...
          <td>
            ...
            <Moment format="MMM DD, YYYY hh:mm A" className={`${
                  dtoday == moment(meeting.dateOfMeeting).format('YYYY-MM-DD') ? "badge badge-danger" : null
              }`}>
...
const mapStateToProps = (state, ownProps) => {
  const {meetings, isAdmin} = ownProps;
  var dtoday = new Date();
